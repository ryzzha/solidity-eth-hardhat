...
export interface DutchAuctionInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "nextBlock", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "nextBlock", data: BytesLike): Result;
...
export interface DutchAuction extends BaseContract {
  ...
  nextBlock: TypedContractMethod<[], [void], "nonpayable">;
