import type { GovernToken } from "../typechain";
import type { EventLog, SignerWithAddress } from "./setup";
import { ethers, expect, loadFixture, mine, time, AddressLike } from "./setup";
